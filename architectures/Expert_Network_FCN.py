...
class Expert_network(nn.Module):
    def __init__(self, config_file):
        ...
        self.fc = nn.ModuleList([nn.Sequential(Sub_network(8,TOTAL_CLASS,stride=1),
                                                nn.AdaptiveAvgPool2d(1)) for i in range(3)])
    ...
    def forward(self, x, features=False,gate1_manual=None, gate2_manual=None,temperature = 1.0):
        ...
        out2 = [torch.squeeze(self.fc[i](out_2[i])) for i in range(3)]
