...
class Experiment1(object):
    ...
    def training(self, dataloader_train, dataloader_val, batch_multiplier = 1):
        ...
        for e in tqdm(range(current_epoch+1, epochs+1)):
            ...
            write_to_file_in_dir(saved_model_path, 'training_c_losses.txt', c_losses)
            write_to_file_in_dir(saved_model_path, 'training_v_losses.txt', v_losses)
            write_to_file_in_dir(saved_model_path, 'valACC.txt', valAcc)
